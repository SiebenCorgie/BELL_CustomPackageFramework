...
def execute_install(Name, Distribution,Uninstall):
	...
	if Distribution == 'debian':
		if Distribution == 'debian' and Uninstall == False:
			output = SI.execute('pkexec apt-get install -y ' + Name, True)
		
		elif Distribution == 'debian' and Uninstall == True:
			output = SI.execute('pkexec apt-get remove -y ' + Name, True)
	...
	#Arch
		...
		if Distribution == 'arch' and Uninstall == False:
			output = SI.execute('pkexec pacman -S ' + Name + ' --noconfirm' , True)
		elif Distribution == 'arch' and Uninstall == True:
			output = SI.execute('pkexec pacman -Rs ' + Name + ' --noconfirm' , True)			
